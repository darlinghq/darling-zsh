...
static zlong getarg _((char**str,int*inv,Value v,int a2,zlong*w,int*prevcharlen,int*nextcharlen));
static void check_warn_create _((Param pm,const char*pmtype));
